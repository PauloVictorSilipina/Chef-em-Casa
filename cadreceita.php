...
<body>
    ...
    <div class="container envio-receitas">
        ...
        <div class='dados-cad-rec col-12 row'>
            <div class='adicionar-imagem col-lg-4 col-12'>
                <div class='imagem col-lg-10 offset-lg-1 col-11 offset-1'><img id="foto-img" src='https://i.imgur.com/ay14UT1.png'></div>
                <input type="file" id="file-input" name="file-input"/>
                <label class="col-lg-8 offset-lg-0 col-11 offset-1" id="file-input-label" for="file-input">Escolha uma imagem</label>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <span class="sub-titulos offset-lg-0 offset-1">Dificuldade</span>
                <fieldset class='dificuldades'>
                    <select class="col-lg-6 offset-lg-0 col-8 offset-1" name="medida" id="dif">
            ...
            <div class="col-lg-4">
                <span class="sub-titulos offset-lg-0 offset-1">Tempo de Preparo (em minutos)</span>
            ...
            <div class="col-lg-4">
                <span class="sub-titulos offset-lg-0 offset-1">Número de pessoas ou porções</span><br>
                <div class="row no-gutters">
                    <input class="col-lg-2 col-2 offset-2" id="porc"></input>
                    <select class="col-lg-3 col-6" name="medida" id="dif">
    ...
    <div class="container">
        <div class="col-lg-12">
            <div class="row">
                <div class="col-lg-6 col-11 offset-lg-0">
                    <span class="sub-titulos offset-lg-0 offset-1">Ingredientes</span>
                    <div class="ing-inicio col-lg-6 offset-lg-0 col-12 offset-1" id="ingrediente-inicio">
                        <div class="ingrediente col-lg-12 col-12 row" id="ingrediente">
                            <input class="col-lg-4 col-4" placeholder="Ingrediente" id="nome-ing">
                            <input class="col-lg-3 col-3" placeholder="Qtd" id="qtd">
                            <select class="col-lg-3 col-3" name="medida" id="medida">
                ...
                <div class="col-lg-6">
                    <span class="sub-titulos offset-lg-0 offset-1">Preparo</span>
        ...
        <button type="submit" class="offset-lg-5 col-lg-2 col-10 offset-1 btnCadastrar" id="btnCadastrar">Enviar minha receita</button>
    </div> 
    <?php
    include "footer.php";
    ?>
