            ...
            <div class="dados col-lg-4 col-10 offset-1 offset-lg-4">
                <form id="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <div class="col-lg-12 input-control">
                        ...
                        <input type="text" name="email" id="email" placeholder="Digite o email" class="col-lg-10 col-10 offset-1" name="email" required autofocus>
                        <div class="error"></div>
                    </div>
                    
                    <div class="col-lg-12 input-control">
                        <label for="usuario" class="col-lg-12 col-10 offset-1">Usuário</label>
                        <input type="text" name="usuario" id="usuario" placeholder="Digite o usuário" class="col-lg-10 col-10 offset-1" name="usuario" required>
                        <div class="error"></div>
                    </div>
                    
                    <div class="col-lg-12 input-control">
                        <label for="password" class="col-lg-12 col-10 offset-1">Senha</label>
                        <input type="password" name="senha" id="password" placeholder="Deve conter 6 caracteres ou mais" class="col-lg-10 col-10 offset-1" name="senha" required>
                        <div class="error"></div>
                    </div>

                    <div class="col-lg-12 input-control">
                        <label for="password" class="col-lg-12 col-10 offset-1">Confirme a senha</label>
                        <input type="password" id="confirm-password" placeholder="Confirme sua senha" class="col-lg-10 col-10 offset-1" name="cfsenha" required>
                        <div class="error"></div>
                    </div>
