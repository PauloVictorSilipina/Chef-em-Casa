...
<body>
    ...
    <div class="container envio-receitas">
        ...
        <div class='dados-cad-rec col-12 row'>
            <div class='adicionar-imagem col-lg-4 offset-lg-0 col-12'>
                <div class='imagem col-lg-10 offset-lg-1 col-11 offset-1'><img id="foto-img" src=''></div>
                <input type="file" id="file-input" name="file-input"/>
                <label  class="col-8 offset-lg-2 col-11 offset-1" id="file-input-label" for="file-input">Escolha uma imagem</label>
            </div>
        ...
        <div class="row">
            <div class="col-lg-4 offset-lg-0">
                ...
                <fieldset class='dificuldades'>
                    <select class="col-lg-6 col-9" name="medida" id="dif">
            ...
            <div class="col-lg-4">
                ...
                <div class="slidecontainer row">
                    <input type="range" min="1" max="100" value="50" class="col-lg-8 offset-1 col-8 offset-1" id="myRange">
    ...
    <div class="container">
        ...
        <button type="submit" class="offset-lg-5 col-lg-2 offset-1 col-10 btnCadastrar" id="btnCadastrar">CADASTRAR RECEITA</button>
    </div> 
    <?php
    include "footer.php";
    ?>
